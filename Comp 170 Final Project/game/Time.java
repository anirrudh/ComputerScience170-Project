/**
 * Created by SBlack on 25-Apr-16.
 */
import java.util.Scanner;

/**This code gives player's current day, hour, and whether it is day or night*/
public class Time {
    ...
    public int getDay(){
        int day;
        day = (int) Math.ceil((hour / 12));
        return day;
    }

    /**Get playerInput from Main or such*/
